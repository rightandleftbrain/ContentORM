...
class ReferenceField(Field):
    def __init__(self, model_set={}, error_msg='', disabled=False, localized=False, omitted=False, required=False,
                 validations=None, default=None):
        ...
        super().__init__(disabled=disabled, localized=localized, omitted=omitted, required=required,
                         validations=validations, default=default)
...
class ArrayField(Field):
    ...
    def __init__(self, items, disabled=False, localized=False, omitted=False, required=False, validations=None,
        ...
        if type(items) not in [SymbolField, ReferenceField, MediaField]:
            raise TypeError(
                'ArrayField currently only accecpt SymbolField, ReferenceField and MediaField. Detected: ' + str(
                    type(items)) + '.')
